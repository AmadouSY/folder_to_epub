...
class BooksView(ctk.CTkFrame):
    """Visual explorer detailing discovered books, chapters, and image counts."""
        ...
        if self.app.is_batch_mode and self.app.books:
            ...
            for idx, book in enumerate(self.app.books, start=1):
                ...
                sub_lbl = ctk.CTkLabel(
                    col,
                    text=f"{book.chapter_count} chapter(s) • {book.total_images} pages • Cover: {cov_str}",
