...
========================
A clean, modular Python tool for converting directories of images into EPUB 3 eBooks.
"""

from folder_to_epub.core.constants import APP_NAME, APP_TITLE, APP_VERSION, SUPPORTED_EXTENSIONS, DEFAULT_CSS
